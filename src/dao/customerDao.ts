...
export interface CustomerDao {
    createCustomer(customer: CreateCustomerDTO |ManageCustomerRequest, customerRepo: Repository<Customer>): Promise<Customer>;
    ...
    listCustomer(paginationDto: CommonPaginationDto): Promise<{list:Customer[];count:number}>;
    findCustomers(loadRequest:loadRequestDTO):Promise<Customer[]>;
}